...
(function() {
  ...
  function getHeaderHTML() {
    ...
    return `<header class="apex-header"><div class="apex-header__container"><a href="${desktopLogo.href}" class="apex-header__logo${alternateClass}"><img src="${desktopLogo.src}" alt="${desktopLogo.alt}"></a><nav><ul class="apex-header__nav">${generateNavItems()}</ul></nav><div class="apex-header__actions">${generateActionLinks(false)}<button type="button" class="apex-header__mobile-toggle js-mobile-toggle" aria-label="Open menu" aria-expanded="false"><span class="apex-header__hamburger"></span></button>${generateCartButton()}</div></div></header><div class="apex-mobile-backdrop js-mobile-backdrop"></div><div class="apex-mobile-drawer js-mobile-drawer" aria-hidden="true"><div class="apex-mobile-drawer__header"><a href="${mobileLogo.href}" class="apex-mobile-drawer__logo${alternateClass}"><img src="${mobileLogo.src}" alt="${mobileLogo.alt}"></a><div class="apex-mobile-drawer__header-actions"><button type="button" class="apex-mobile-drawer__close js-mobile-close" aria-label="Close menu"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M18 6L6 18M6 6l12 12"/></svg></button>${generateCartButton()}</div></div><nav><ul class="apex-mobile-drawer__nav">${generateMobileNavItems()}</ul></nav><div class="apex-mobile-drawer__footer">${generateActionLinks(true)}</div></div><div class="apex-header-spacer"></div>`;
  }
